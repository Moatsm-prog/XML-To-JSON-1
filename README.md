...
- **		How it works:**
 - The function removing whitespaces from left and right part of the string by count the whitespaces of the left part in the first while loop and count the whitespaces of the right part in the second while loop and then use substr() to remove this spaces from our string.
- 	**	Role in the code:**
